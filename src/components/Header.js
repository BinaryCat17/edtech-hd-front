...
const Header = () => {
    const brend = (<>
        <img src="/assets/logo/ussr.png" width="70" height="70" />
    </>);

    return (
        <Container fluid className="col-12 p-0 fixed-top navbar-light">
            <div className="d-flex p-0">
                ...
                <div className="pr-2 d-flex col-auto">
                    ...
                    <img src="/assets/logo/social.png" width="60" height="70" />
                </div>
            </div>
        </Container>
    );
